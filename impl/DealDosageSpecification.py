...
path_dosage = IOUtils.get_path_sources("剂型规格详情表5.xlsx")
path_altername = IOUtils.get_path_sources("成分名异名表v2.0.xlsx")

pd_datamate2 = pd.read_excel(path_altername)
pd_datamate3 = pd.read_excel(path_dosage)
...
# 清洗药品剂型规格
def deal_dosage_specification(dfA):
	dfC = pd_datamate3
	...
	dfB['规格-mg'] = dfB['规格2'].apply(specification_extraction, args=(2,))
	dfB['规格-ml'] = dfB['规格2'].apply(specification_extraction, args=(3,))
	dfB['规格-iu'] = dfB['规格2'].apply(specification_extraction, args=(4,))
	dfB['规格-%'] = dfB['规格2'].apply(specification_extraction, args=(5,))
	del dfB['规格2']
