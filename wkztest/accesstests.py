...
class AccessTestCase(unittest.TestCase):
	...
	LARGE_FENCEPOST_SIZES = [256, 270, 304, 508, 510, 511, 512, 1023, 1024, 2047, 2048, 4000, 4095, 4096, 4097,
							 10 * 1024, 20 * 1024]
	...
	def _test_strtype(self, sqltype, value, colsize=None):
		...
		"""
		assert colsize is None or (value is None or colsize >= len(value)), 'colsize=%s value=%s' % (
